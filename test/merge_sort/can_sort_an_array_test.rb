...
describe MergeSort, "Testing Merge Sort" do
  ...
  puts Benchmark.measure {MergeSort.sort_it lo_to_hi}
  puts Benchmark.measure {MergeSort.sort_it hi_to_lo}
  puts Benchmark.measure {MergeSort.sort_it random_arry}
